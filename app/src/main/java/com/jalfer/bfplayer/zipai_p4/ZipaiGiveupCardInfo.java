...
public class ZipaiGiveupCardInfo {
    ...
    public ZipaiGiveupCardInfo(char cardName, Context mContext){
        this.cardName = cardName;
        int cardId = ZipaiJinziCardInfo.ZipaiNameToImgId(cardName);
        this.mContext = mContext;

        Bitmap bitmap1 = ((BitmapDrawable) ContextCompat.getDrawable(mContext, R.drawable._05)).getBitmap();
