...
public class JZipaiJinziCardAdapter extends RecyclerView.Adapter<JZipaiJinziCardAdapter.ViewHolder> {

    private Context mContext;
    private List<JZipaiJinziCardInfo>  jinziCardInfoList;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        JZipaiJinziCardInfo cardInfo = jinziCardInfoList.get(position);
    ...
    public JZipaiJinziCardAdapter(List<JZipaiJinziCardInfo> jinziCardInfoList){
